...
<body>
    ...
    <div class="d-flex">
        <!-- Sidebar -->
        <div class="d-flex flex-column bg-dark text-white shadow sidebar" style="height: 120vh;">
            <div class="d-flex flex-column justify-content-center align-items-center text-center logo-wrapper">
                ...
                <span class="fs-6 fw-semibold text-uppercase px-3 text-white text-wrap">PT. Sawit Jaya</span>
            </div>
